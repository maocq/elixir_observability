defmodule ElixirObservability.Utils.CustomTelemetry do
  ...
  @service_name Application.compile_env!(:elixir_observability, :custom_metrics_prefix_name)
  ...
  def custom_telemetry_events() do
    :telemetry.attach("elixir_observability-plug-stop", [:elixir_observability, :plug, :stop], &handle_custom_event/4, nil)
    :telemetry.attach("elixir_observability-redis-stop", [:redix, :pipeline, :stop], &handle_custom_event/4, nil)
    :telemetry.attach("elixir_observability-vm-memory", [:vm, :memory], &handle_custom_event/4, nil)
  ...
  def handle_custom_event([:elixir_observability, :plug, :stop], measures, metadata, _) do
    :telemetry.execute(
